<script setup>
import { InputTextarea } from '~Components/core/forms'
...
<template>
  <form @submit.prevent="">
    <div class="mb-6">
      <InputTextarea v-model="pengaturan.header" :error="pengaturan.errors.header" @clear-error="clearError"
        title="Kode Header Tambahan" name="header" required/>
      <InputTextarea v-model="pengaturan.footer" :error="pengaturan.errors.footer" @clear-error="clearError"
        title="Kode Footer Tambahan" name="footer" required/>
    </div>
