...
<template>
    <GeneralLayout title="Halaman Utama">
                ...
                <div class="items-center justify-between w-full md:flex md:w-auto md:order-1"
                    ...
                    <ul
                        ...
                        <li v-for="(menu, index) in menuContent" :key="index">
                            <component :is="(menu.uri && !menu.uri.startsWith('#')) ? 'Link' : 'a'" :href="menu.uri"
                                v-if="!menu.submenu"
        ...
        <main>
            ...
            <Transition enter-from-class="-translate-y-full scale-x-50 opacity-0" enter-active-class="duration-500"
                ...
                <section :key="currentJumbotron" @mouseenter="unloopJumbotron" @mouseleave="loopJumbotron"
                    ...
                    <div
                        class="translate-y- px-4 text-center py-24 lg:py-[15rem] hover:backdrop-blur-sm transition ease-out duration-200">
                        <h1
            ...
            <!-- Artikel -->
            <section id="kontak"
                class="scroll-my-20 py-10 bg-white dark:bg-gray-900 flex flex-col items-center justify-center ">
                <h1
                ...
                <div class="py-4 px-4 mx-auto max-w-screen-xl md:py-16 lg:px-6">
                    <div class="space-y-4 md:grid xl:grid-cols-4 md:grid-cols-2 sm:gap-3 xl:gap-5 lg:space-y-0">
                        <div
                            class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                Noteworthy technology acquisitions 2021
                            </h5>
                            <div class="mt-2.5 mb-5 divide-x-2 divide-gray-500 dark:divide-gray-700">
                                <span
